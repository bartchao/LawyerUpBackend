...
{
    public partial class LawyerUP_10Context : DbContext
    {
        public LawyerUP_10Context()
        {
        }

        public LawyerUP_10Context(DbContextOptions<LawyerUP_10Context> options)
            : base(options)
        {
        }
